...
clear;
DECODER='ORBGRAND-MSB3-TIEBREAK1-PRUNED';
%% Code parameters
...
for ii=1:numSNR
    ...
    while num_errs(ii)<err_thresh
        ...
        if isequal(DECODER,'ORBGRAND-MSB3-TIEBREAK1-PRUNED')
            [y_decoded,n_guess] = ORBGRAND_msb_tiebreak1_pruned_quant_mex(y_soft',uint8(reshape(H', [], 1)),uint64(max_query));
            y_decoded =y_decoded';
