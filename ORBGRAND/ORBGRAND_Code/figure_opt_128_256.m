...
function make_fig_combined(codes128,codes256,fig_no)
    ...
    % ===================== LEGENDS =====================
    lgd1 = legend(ax1,h128,labels128, ...
        'Interpreter','latex', ...
        'Location','northeast', ...
        'FontSize',LEG_FONT, ...
        'Box','on');
    ...
    lgd2 = legend(ax2,h128,labels128, ...
        'Interpreter','latex', ...
        'Location','northeast', ...
        'FontSize',LEG_FONT, ...
        'Box','on');
    ...
    lgd3 = legend(ax3,h256,labels256, ...
        'Interpreter','latex', ...
        'Location','northeast', ...
        'FontSize',LEG_FONT, ...
        'Box','on');
    lgd3.NumColumns = 1;
    lgd3.ItemTokenSize = [14 8];

    lgd4 = legend(ax4,h256,labels256, ...
        'Interpreter','latex', ...
        'Location','northeast', ...
        'FontSize',LEG_FONT, ...
        'Box','on');
    lgd4.NumColumns = 1;
    lgd4.ItemTokenSize = [14 8];
